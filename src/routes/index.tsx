  ...
  return (
    <Link to="/" className="flex items-center gap-2.5 group">
      <img
        src={logo}
        alt="SparkHosting"
        className="h-11 w-11 object-contain rounded-full drop-shadow-[0_0_18px_rgba(217,70,239,0.7)] transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[6deg]"
      />
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-10 flex flex-col gap-6">
          ...
          <div className="text-xs text-muted-foreground pt-4 border-t border-border">
            Made with <span className="text-red-500">❤️</span> By <a href="https://discord.com/users/1151903297335218319" target="_blank" rel="noopener noreferrer" className="hover:text-foreground underline">! Mohit</a>
          </div>
        </div>
      </footer>
    </div>
